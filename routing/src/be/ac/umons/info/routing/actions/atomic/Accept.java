...
/**
 * Action "Accept": for all input routes, set their "modified" status to 
 * accepted.
 */
public final class Accept implements IAction {
	...
	public FilterAutomaton automaton(final RouteAlphabet routeAlphabet,
		...
		rulesMod.add(new BasicRule<LabelPair,FilterState>(
			ActionAlphabet.MODACC, q1));
		rulesMod.add(new BasicRule<LabelPair,FilterState>(
			ActionAlphabet.ACCACC, q1));
