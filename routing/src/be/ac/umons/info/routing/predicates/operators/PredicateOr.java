...
/**
 * Disjunction (OR) of two predicates.
 */
public class PredicateOr implements IPredicate {
	 ...
	 * Constructor.
	 */
	public PredicateOr(final IPredicate leftPredicate, 
	...
	public PredicateAutomaton automaton(final RouteAlphabet routeAlphabet) {
		return leftPredicate.automaton(routeAlphabet)
			.syncUnion(rightPredicate.automaton(routeAlphabet));
	}
	...
	/**
	 * Returns the left predicate of this disjunction.
	 */
	...
	/**
	 * Returns the right predicate of this disjunction.
	 */
	...
	public String toString() {
		return "(" + this.leftPredicate().toString() + " OR " 
