...
/**
 * This predicate tests whether a given value is in the AS path.
 */
public class PathIn implements IPredicate {
	 ...
	 * Constructor
	 */
	public PathIn(final int elemValue) {
	...
	public String toString() {
		return "AS-path contains " + this.elemValue;
	}
}
